...
myStatusBar = "conky -c /home/ryuunosuke/.xmonad/.conky_dzen | dzen2 -x '2080' -w '1040' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
myBitmapsDir = "/home/ryuunosuke/.xmonad/dzen2"
--}}}
-- Main {{{
main = do
...
keys' conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
    ...
    , ((modMask,                    xK_q        ), spawn "killall conky dzen2 && /home/ryuunosuke/.cabal/bin/xmonad --recompile && /home/ryuunosuke/.cabal/bin/xmonad --restart")
    ]
    ++
